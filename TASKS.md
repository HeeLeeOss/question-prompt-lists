...
- A named clinic/advocacy org confirmed in writing as requestor; agreed **population, journey
  ...
  Hee-Lee Oss). On completion, related tasks update `requestor` + `verifiedNeed: true`.
...
Generated by Hee-Lee Oss task-decomposition agent on 2026-06-29. All files in `tasks/` are schema-valid
...
```json
{
  ...
  "resources": [
    "C:/code/hee-lee-oss/planning/projects/question-prompt-lists/PLAN.md",
